...
class Biopsy(CommonInfo): #2
	...
	biopsy_name = models.ForeignKey('BiopsyName',blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
	biopsy_location = models.ForeignKey('Location', blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
	biopsy_result = models.ForeignKey('BiopsyResult', blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
	biopsy_text = models.TextField(blank = True, null = True)
	visit = models.ForeignKey('Visit', blank = True, null = True, editable = False, default = None, on_delete=models.SET_DEFAULT)
...
class Complaint(CommonInfo): #4
	id = models.AutoField(primary_key=True)
	complaint_name = models.ForeignKey(ComplaintName, blank = False, null = False, default = None, on_delete=models.SET_DEFAULT)
	complaint_location = models.ForeignKey('Location', blank = False, null = False, default = None, on_delete=models.SET_DEFAULT)
	visit = models.ForeignKey('Visit', blank = True, null = True, editable = False, default = None, on_delete=models.SET_DEFAULT)
...
#class Drawing(CommonInfo): #6
	#id = models.AutoField(primary_key=True)
	#patient = models.ForeignKey('Patient', blank=True, null=True, on_delete=models.SET_DEFAULT)
...
class Exam(CommonInfo): #7
	id = models.AutoField(primary_key = True)
	exam_name = models.ForeignKey(ExamName, blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
	exam_date = models.DateField(blank=True, null=True)
	exam_type = models.ForeignKey('ExamType', blank=True, null=True, default = None, on_delete=models.SET_DEFAULT)
	exam_result = models.ForeignKey('ExamResult', blank=True, null=True, default = None, on_delete=models.SET_DEFAULT)
...
class Hearing(CommonInfo):
	id = models.AutoField(primary_key=True)
	hearing_test = models.ForeignKey('HearingTest', blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
	hearing_result = models.ForeignKey('HearingResult', blank = True, null = True, default = None, on_delete=models.SET_DEFAULT)
...
class Prescription(CommonInfo):
	id = models.AutoField(primary_key=True)
	patient = models.ForeignKey(Patient, blank=True, null=True, default = None, on_delete=models.SET_DEFAULT, editable = False)
	medicine = models.ForeignKey(Medicine, blank=True, null=True, default = None, on_delete=models.SET_DEFAULT)
	medicine_dose = models.ForeignKey(Dose, blank=True, null=True, default = None, on_delete=models.SET_DEFAULT)
	prescription_reminder = models.ForeignKey('Reminder', blank=True, null=True, default = None, on_delete=models.SET_DEFAULT)
...
class Visit(CommonInfo):
	...
	patient = models.ForeignKey(Patient, blank=False, null=False, default = None, on_delete=models.SET_DEFAULT)
