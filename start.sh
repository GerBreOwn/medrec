...
#####
#set -e
#python3 /medrec/config/database-check.py > /dev/null 2>&1
#while [[ $? != 0 ]] ; do
...
#####
    ...
    #python3 /medrec/${DJANGO_PROJECT_NAME}/manage.py makemigrations
    #python3 /medrec/${DJANGO_PROJECT_NAME}/manage.py migrate #--fake-initial
    ...
    #python3 /medrec/${DJANGO_PROJECT_NAME}/manage.py collectstatic --noinput -v 3
#else
    ...
    #python3 /medrec/${DJANGO_PROJECT_NAME}/manage.py flush --noinput
