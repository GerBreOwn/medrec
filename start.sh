...
#####
set -e
python3 /web/config/database-check.py > /dev/null 2>&1
while [[ $? != 0 ]] ; do
...
if [ "$PRODUCTION" == "true" ]; then
    ...
    python3 /web/${DJANGO_PROJECT_NAME}/manage.py makemigrations
    python3 /web/${DJANGO_PROJECT_NAME}/manage.py migrate #--fake-initial
    ...
    python3 /web/${DJANGO_PROJECT_NAME}/manage.py collectstatic --noinput -v 3
else
    ...
    python3 /web/${DJANGO_PROJECT_NAME}/manage.py flush --noinput
